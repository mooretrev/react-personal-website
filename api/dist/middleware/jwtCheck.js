...
exports.default = (function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var token, jwtPayload, userRecord, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                jwtPayload = jsonwebtoken_1.default.verify(token, process.env.SIGNATURE);
                req.jwtPayload = jwtPayload;
                return [4 /*yield*/, user_js_1.default.findById(jwtPayload.data._id)];
            case 2:
                userRecord = _a.sent();
